...
Plot:
```{r}
autoplot(m6$fitted.values, ylab = "Walmart Sales", xlab = "Time",series = "Fitted Value", main = "Regression Prediction of Sales") 
+ autolayer(WeeklySales.ts, series = "True Value")
```
