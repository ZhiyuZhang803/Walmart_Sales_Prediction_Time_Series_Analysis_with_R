...
We will try SARIMA(5,0,0)x(1,0,1) first.
...
checkresiduals(m1)
```
For SARMA(5,0,0)x(1,0,1), the RMSE in training set is 42055.07 and RMSE in Test set is 45170.57.
...
```
For SARMA(5,0,5)x(1,0,1), the RMSE in training set is 40241.62 and RMSE in Test set is 47998.56.
...
```
For SARMA(5,0,1)x(1,0,1), the RMSE in training set is 42052.92 and RMSE in Test set is 45152.82. 
...
```
For SARMA(5,0,0)x(1,0,0), the RMSE in training set is 42097.27 and RMSE in Test set is 44540.73. We decide to use this model as our final model. 
